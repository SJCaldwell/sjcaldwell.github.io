...
This, then, is ultimately a plea to organizers and reviewers of conferences that cover offensive AI: require a benchmark in submissions. If none exists for the use-case, eagerly accept talks that have constructed such a benchmark, however imperfect, so long as it is _released_. 
